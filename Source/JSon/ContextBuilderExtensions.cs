...
namespace LeanTest.JSon
{
    ...
    public static class ContextBuilderExtensions
    {
        ...
        /// </summary>
        public static IContextBuilder WithData<T>(this IContextBuilder contextBuilder, string json)
        {
        ...
        /// </summary>
        public static IContextBuilder WithEnumerableData<T>(this IContextBuilder contextBuilder, string json)
        {
            var creator = new JsonDataCreatorForTest<T>();
